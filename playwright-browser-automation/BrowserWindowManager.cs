...
public class BrowserWindowManager
{
    ...
    private BrowserWindow[] _windows = new BrowserWindow[0];

    // The unique identifier of the currently active window.
    // Guid.Empty indicates no active window is set.
    ...
    // Returns the currently active BrowserWindow.
    ...
    // Returns all managed browser windows as an array.
